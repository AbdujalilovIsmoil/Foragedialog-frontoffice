              ...
              <nav className="space-y-3">
                {pages.map((page) => (
                  <Link
                    key={page.name}
                    href={page.href}
                    className="block text-gray-600 hover:text-black hover:translate-x-2 transition-all duration-300 group text-center lg:text-left"
                  >
                    <span className="flex items-center justify-center lg:justify-start">
                      <span className="w-0 group-hover:w-2 h-0.5 bg-gradient-to-r from-emerald-500 to-teal-600 transition-all duration-300 mr-0 group-hover:mr-3"></span>
                      {page.name}
                    </span>
                  </Link>
                ))}
